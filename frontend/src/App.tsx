...
function App() {
  ...
  const handleExportPDFWithHTML = (customer: Customer, filteredTransactions?: Transaction[]) => {
    ...
    const arabicTextWeight = language === 'ar' ? 'font-weight: 600;' : ''
    element.innerHTML = `
  ...
  const exportDateRangePDF = () => {
    ...
    const arabicFontStyle = language === 'ar' ? 'font-weight: 600;' : ''
    ...
    const pdfFooterHtml = language === 'ar'
      ? `<span dir="rtl" style="display:inline-block; direction:rtl; text-align:center; unicode-bidi:plaintext; font-family: Tahoma, Arial, sans-serif; font-weight: 600;">Flash</span>`
      : language === 'en'
        ? 'Flash'
        : 'Flash'
    const currentDate = new Date().toLocaleDateString(language === 'ar' ? 'ar-EG' : 'tr-TR', {
